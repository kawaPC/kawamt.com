...
例えば、programmingタグの記事一覧のページ [https://kawamt.com/entry/tags/programming](https://kawamt.com/entry/tags/programming) のSSGでは、pathとして`/entry/tags/programming`が指定され、publicに同階層のRSSファイルが生成される。
